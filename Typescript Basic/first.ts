...
//có thể kết hợp nhiều kiểu phức tạp
...
function test(x, ...paramsConLai: string[]){ }
...
//khi dùng async function thì type phải dùng là Promise<gì đó> với cái bên trong là giá trị ta return
//Thực tế ta chỉ return ra 1 object bth nhưng cứ là async là phải nhét vào Promise<>
